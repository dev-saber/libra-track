...
int main()
{
    ...
    do
    {
        ...
        cout << "19. Update Subscription History" << endl;
        ...
        cout << "25. Borrow Book" << endl;
        cout << "26. Show All Borrowed" << endl;
        cout << "27. Show Current Borrow Count of a User" << endl;
        cout << "28. Show Current Borrow Books of a User" << endl;
        cout << "29. Return a Borrow Book" << endl;
        cout << "0. Exit" << endl;
        ...
        case 19:
            int sub_his_id;
            cout << "Enter the subscription history id: ";
            cin >> sub_his_id;
        ...
        case 27:
            ...
            cin >> member_id;
            count = storage_instance.get_count_borrowed(member_id, false);
        ...
        case 28:
            ...
            cout << "Enter the ID of the  member: ";
            cin >> member_id_2;
            count1 = storage_instance.get_count_borrowed(member_id_2, true);
            break;
        case 29:
            int borrow_his_id;
            cout << "Enter the ID of the  member: ";
            cin >> borrow_his_id;
            storage_instance.return_a_borrow(borrow_his_id);
            break;
        case 0:
